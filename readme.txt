...
== Changelog ==
= 1.1.2 - 2026-05-05 =
* ENHANCEMENT: Updated email templates to use liquid `{{ }}` variable syntax when running Paid Memberships Pro v3.7+, with backwards-compatible fallback to legacy `!!` syntax for older versions of PMPro. #76 (@dparker1005)
