...
class PMPro_Email_Template_PMProGL_Gift_Purchased_Admin extends PMPro_Email_Template {
	...
	public static function get_template_slug() {
		return 'pmprogl_gift_purchased_admin';
	}
	...
	public static function get_template_description() {
		return esc_html__( 'This email is sent to the admin as confirmation of gift purchase after checkout.', 'pmpro-gift-levels' );
	}
	...
	public static function get_default_body() {
		return pmprogl_get_default_gift_purchased_admin_email_body();
	}
